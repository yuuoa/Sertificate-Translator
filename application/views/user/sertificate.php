<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns="http://www.w3.org/TR/REC-html40">
    ...
    <body style="tab-interval:21pt;text-justify-trim:punctuation;" >
        ...
        <!--StartFragment-->
            ...
            <?php
                ...
                function jurGelar($jurusan)
                {
                    switch($jurusan)
                    {
                        case "TEKNIK INFORMATIKA": return "SARJANA TEKNIK (ST)";
                        case "TEKNIK ELEKTRO": return "SARJANA TEKNIK (ST)";
                        case "AGROTEKNOLOGI": return "SARJANA TEKNIK (ST)";
                        case "MATEMATIKA": return "SARJANA SAINS (S.Si)";
                        case "FISIKA": return "SARJANA SAINS (S.Si)";
                        case "KIMIA": return "SARJANA SAINS (S.Si)";
                        case "BIOLOGI": return "SARJANA SAINS (S.Si)";
                    }
                }
                ...
                $this->db->select();
                $this->db->from('mahasiswa as mh');
                $this->db->where('mh.nim', $i->nim);
                $query = $this->db->get();
                $row = $query->row();
                
                $this->db->select('jur.kode,jur.nama');
                $this->db->from('jurusan as jur');
                $this->db->where('jur.kode',$row->id_jurusan);
                $query2 = $this->db->get();
                $row2 = $query2->row();
            ?>
        ...
        <div class="Section0"  style="layout-grid:18,0000pt;" >
                ...
                <tr style="height:13,7000pt;" >
                    <td width=664  valign=top  style="width:498,0000pt;padding:0,0000pt 5,4000pt 0,0000pt 5,4000pt ;border-left:none;border-right:none;border-top:none;border-bottom:none;" >
                        <p class=MsoNormal  align=justify  style="mso-pagination:none;text-align:justify;text-justify:inter-ideograph;" >
                            ...
                            <span style="font-family:'Times New Roman';mso-fareast-font-family:SimSun;" ><o:p></o:p></span>
                        </p>
                    </td>
                    <td width=664  valign=top  style="width:498,0000pt;padding:0,0000pt 5,4000pt 0,0000pt 5,4000pt ;border-left:none;border-right:none;border-top:none;border-bottom:none;" >
            ...
            <p class=MsoNormal >
                <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;" ><o:p>&nbsp;</o:p></span>
            </p>
            <p class=MsoNormal >
                <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;" ><o:p>&nbsp;</o:p></span>
            </p>
            ...
            <p class=MsoNormal >
                ...
                <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;" ><o:p>&nbsp;</o:p>
            </span></p>
            <p class=MsoNormal >
                <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;" ><o:p>&nbsp;</o:p></span>
            </p>
            ...
            <p class=MsoNormal  align=center  style="text-align:center;" >
                <b>
                    <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:bold;font-size:12,0000pt;" >MINISTRI OF RELOGIOUS AFFAIRS</span>
                </b>
                <b>
                    <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:bold;font-size:12,0000pt;" ><o:p></o:p></span></b>
            </p>
            <p class=MsoNormal  align=center  style="text-align:center;" >
                <b>
                ...
                <b>
                    <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:bold;font-size:12,0000pt;" ><o:p></o:p></span>
                </b>
            </p>
            <p class=MsoNormal  align=center  style="text-align:center;" >
                <b>
            ...
            <p class=MsoNormal  align=center  style="text-align:center;" >
                <b>
                    <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:bold;" ><o:p>&nbsp;</o:p></span>
                </b>
            </p>
            ...
            <p class=MsoNormal  align=center  style="text-align:center;line-height:150%;" >
                <b>
                    <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:bold;font-size:12,0000pt;" ></span>
                </b>
                <b>
                    <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:bold;font-size:12,0000pt;" ><o:p></o:p></span>
                </b>
            ...
            <p class=MsoNormal  align=center  style="text-align:center;line-height:150%;" >
                <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:normal;font-size:10,5000pt;" >Student ID Number &#60;<?=$i->nim?>&#62;</span>
                <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:normal;font-size:10,5000pt;" ><o:p></o:p></span>
            </p>
            <p class=MsoNormal  align=justify  style="text-align:justify;text-justify:inter-ideograph;" >
                <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:normal;font-size:10,5000pt;" >Born in &#60;<?=$row->tempat_lahir?>&#62;, &#60;<?=$row->tanggal_lahir?>&#62;, has finished and fulfilled all the requirement at Study Program of &#60;<?= $row2->nama?>&#62;, therefore the University has confirmed upon &#60;<?= $row->jk?>&#62; the degree of:</span>
                <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:normal;font-size:10,5000pt;" ><o:p></o:p></span>
            </p>
            <p class=MsoNormal  align=center  style="text-align:center;line-height:150%;" >
                <b>
                    <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:bold;font-size:16,0000pt;" >&#60;<?= jurGelar($row2->nama)?>&#62;</span>
                </b>
                <b>
                    <span style="mso-spacerun:'yes';font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:bold;font-size:16,0000pt;" ><o:p></o:p></span>
                </b>
            </p>
            ...
            <table class=MsoTableGrid  border=0  cellspacing=0  style="border-collapse:collapse;width:989,0000pt;mso-table-layout-alt:fixed;border:none;mso-padding-alt:0,0000pt 5,4000pt 0,0000pt 5,4000pt ;" >
                <tr style="height:90,2500pt;" >
                    <td width=439  valign=top  style="width:329,6000pt;padding:0,0000pt 5,4000pt 0,0000pt 5,4000pt ;border-left:none;border-right:none;border-top:none;border-bottom:none;" >
                            ...
                            <span style="font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:normal;font-size:10,5000pt;" ><o:p></o:p></span>
                        </p>
                                ...
                                <p class=MsoNormal  align=center  style="mso-pagination:none;text-align:center;" >
                                    ...
                                    <p class=MsoNormal  align=center  style="mso-pagination:none;text-align:center;" >
                                        ...
                                        <p class=MsoNormal  align=center  style="mso-pagination:none;text-align:center;" >
                                                ...
                                                <b>
                                <span style="font-family:'Times New Roman';mso-fareast-font-family:SimSun;font-weight:bold;font-size:10,5000pt;" ><o:p></o:p></span>
                            </b>
                        </p>
                        <p class=MsoNormal  align=center  style="mso-pagination:none;text-align:center;" >
